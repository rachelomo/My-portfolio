      ...
      <div class="contact-container">
        <div class="contact-info">
          <p style="display: flex; align-items: center; gap: 10px;">
            <img src="/email.svg" alt="Logo" class="logo" id="logo" style="width: 7%; filter: brightness(0) invert(1);" />
            <a href="mailto:adebisirachael41@gmail.com" style="color: white; text-decoration: none;">adebisirachael41@gmail.com</a>
          </p>
          <div style="position:relative">
            <img src="/phone.png" alt="Logo" class="logo" id="logo" style="height: auto; color:white; filter: brightness(0) invert(1);" />
